<div class="modal fade" id="modal_contas_pagar">
    <div class="modal-dialog modal-lg" >
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Conta a Pagar</h4>
              </div>
                <div class="erros"></div>
              <div class="modal-body">
                    <form method="POST" id="form-conta-pagar" name="form-conta-pagar">
             ...
             <div class="row">
                ...
                <select class="form-control select2" name="especie_documento" id="especie_documento" style="width: 100%;">
                   ...
                   <option value="duplicata">Duplicata</option>
                    ...
                    <option value="holerite" selected>Holerite</option>
                    <option value="tarifa-boleto">Tarifa Boleto</option>
                ...
                <div class="col-xs-3">
                  <div class="form-group">
                      ...
                      <label>Pagar agora:</label><br>                      
                      
                      <input type="checkbox" name="check_pagar_agora" checked value="sim" data-toggle="toggle" data-on="Sim" data-off="Não" data-width="100%" data-onstyle="success" data-offstyle="danger">
                ...
                <div class="input-group">
                  <div class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  value="<?=date('d/m/Y')?>" id="data_pagamento" name="data_pagamento" >
                </div>
                <!-- /.input group -->
              </div>
              </div>  
                  ...
                  <div class="form-group">
                      ...
                      <label>Pagamento em cheque:</label><br>                      
                      
                      <input type="checkbox" name="check_pagamento_em_cheque" value="sim" checked data-toggle="toggle" data-on="Sim" data-off="Não" data-width="100%" data-onstyle="success" data-offstyle="danger">
                  ...
                  <div class="form-group">
                      ...
                      <label>Cheque compensado:</label><br>                      
                      
                      <input type="checkbox" name="check_cheque_compensado" value="sim" data-toggle="toggle" data-on="Sim" data-off="Não" data-width="100%" data-onstyle="success" data-offstyle="danger">
                ...
                <div class="col-xs-2">
                  ...
                  <div class="form-group">
                        ...
                        <div class="input-group"> 
                            ...
                            <input type="text" class="form-control required somente-numeros" id="id_categoria_despesa" name="id_categoria_despesa" placeholder="" >
                    <span class="input-group-btn">
                      <button type="button" class="btn btn-default btn-flat" id="button-categoria-despesa"><i class="fa fa-search"></i></button>
                    </span>
                        ...
                        <div class="col-xs-4">
                  <div class="form-group">
                        <label>Descrição Rubrica:</label>
                        <input type="text" readonly class="form-control required" id="descricao_categoria_despesa" name="descricao_categoria_despesa" placeholder="Descricao do Gasto de despesa">
                    </div>
                </div>   
...
<div class="col-xs-2">
              ...
              <div class="box-footer">
                  <button type="button" class="btn btn-success" name="pagar_agora" id="pagar_agora"> Salvar</button>
...
$("form#form-conta-pagar #valor_nota, form#form-conta-pagar #valor_parcela, form#form-conta-pagar #desconto_parcela, form#form-conta-pagar #acrescimo_parcela").on('keyup', function(){
...
var total_nota = 0
var acrescimo_nota = $("form#form-conta-pagar #acrescimo_parcela").val().toString().replace(".","").replace(",",".");
var desconto_nota = $("form#form-conta-pagar #desconto_parcela").val().toString().replace(".","").replace(",",".");
var parcela_nota = $("form#form-conta-pagar #valor_parcela").val().toString().replace(".","").replace(",",".");
...
$("form#form-conta-pagar #valor_nota").val(total_nota.toFixed(4).replace(".",","));
    ...
    $("form#form-conta-pagar #button-categoria-despesa").on('click', function(){ 
$.ajax({
...
$("form#form-conta-pagar #id_categoria_despesa").on('keyup', function(){
...
$("form#form-conta-pagar #button-caixa").on('click', function(){ 
$.ajax({
...
$("form#form-conta-pagar #id_conta_bancaria").on('keyup', function(){
if($.isNumeric($(this).val())){
    $.ajax({
...
$("#id_conta_bancaria").val("");
    ...
    $("form#form-conta-pagar #button-tipo-despesa").on('click', function(){ 
$.ajax({
...
$("form#form-conta-pagar #id_tipo_despesa").on('keyup', function(){
...
$("#descricao_tipo_despesa").val("").attr({placeholder:"ID não encontrado...",maxlenght:"14"});
 ...
 $("form#form-conta-pagar #button-forma-pagamento").on('click', function(){
    ...
    $("form#form-conta-pagar #id_forma_pagamento").on('keyup', function(){
if($.isNumeric($(this).val())){
    $.ajax({
...
$("#modal_contas_pagar .erros").html(""); 
    $("#pagar_agora").on("click", function(event){
    event.preventDefault();
    var formDados = new FormData($("#form-conta-pagar")[0]);
    var erros = validarForm("#form-conta-pagar");
    if(erros.length > 0){
       ...
       $.ajax({
        url: '<?=DOMINIO?>contaspagar/pagarconta',
        type: 'POST',
        data: formDados,
        cache: false,
        contentType: false,
...
var erros = "";
    ...
    if($(form+" #numero_cheque").val().length <= 1){
        erros += "Número do Cheque Inválido!";
    } 
    ...
    if(parseInt($(form+" #id_categoria_despesa").val()) <= 0){
        erros += "Id da categoria da conta inválida!";
    } 
    if($(form+" #descricao_categoria_despesa").val().length <= 0){
        erros += "Descrição da categoria da conta inválida!";
    }
