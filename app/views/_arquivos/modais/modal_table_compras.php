<div class="modal fade" id="modal_table_compras">
...
<section class="content">
      <div class="row">
        <div class="col-md-12">
           ...
           <input type="hidden" name="id_linha_selecionada" id="id_linha_selecionada">
           <input type="hidden" name="id_descricao_linha_selecionada" id="id_descricao_linha_selecionada">
...
$(function(){
   ...
   $("#modal_table_compras").on('click','table#compras tbody tr td a.selecionar-compra',function(e){
        e.preventDefault();


        var id = $("#modal_table_compras #id_linha_selecionada").val();
        var descricao_linha = $("#modal_table_compras #id_descricao_linha_selecionada").val();
        ...
        $("#"+ descricao_linha).val(descricao);
        
//        $("#id_fornecedor").val($(this).parent().siblings("td:eq(7)").text());
//        $("#descricao_fornecedor").val($(this).parent().siblings("td:eq(8)").text());
...
//                $("table#table-produtos-cotacao tbody tr").remove(); 
         ...
         $("#modal_table_compras").modal('hide');
         
        });
        
$("#modal_table_compras").on('click','table#compras tbody tr td a.selecionar-compra2',function(e){
        e.preventDefault();
...
//        $.ajax({
//            url: 'compra/listaritensdacompraMercadoria',
//            type: 'post',
//            dataType: 'html',
//            data: {
//                'id' : $("#id_compra").val()
