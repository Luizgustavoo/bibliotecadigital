...
//        echo "<hr>";
    ...
    public static function validarMenuSolicitacaoCompra(){
        ...
        session_start();
        if($_SESSION['setor_usuario'] == 'compras' or
    ...
    public static function validarMenuCheque(){
        ...
        session_start();
        if($_SESSION['setor_usuario'] == 'financeiro'or
            $_SESSION['tipo_usuario'] == 'administrador'){
            return true;
        }else{
            return false;
    ...
    public static function validarMenuHoras(){
        ...
        session_start();
        if($_SESSION['setor_usuario'] == 'coordenacao' or
    ...
    public static function cidadeMesAno(){
        ...
        switch($mess){
            case 'January' : $mess = 'Janeiro'; break;
            case 'February' : $mess = 'Fevereiro'; break;
            case 'March' : $mess = 'Mar&ccedil;o'; break;
            case 'April' : $mess = 'Abril'; break;
            case 'May' : $mess = 'Maio'; break;
            case 'June' : $mess = 'Junho'; break;
            case 'July' : $mess = 'Julho'; break;
            case 'August' : $mess = 'Agosto'; break;
            case 'September' : $mess = 'Setembro'; break;
            case 'October' : $mess = 'Outubro'; break;
            case 'November' : $mess = 'Novembro'; break;
            case 'December' : $mess = 'Dezembro'; break;
        }
